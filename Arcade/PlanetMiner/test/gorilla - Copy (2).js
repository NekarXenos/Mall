...
let cameraPivot;
// The camera offset is now relative to the pivot point (the head)
...
export function init() {
    ...
    // Position the pivot at the head's location
    cameraPivot.position.set(0, 5.75, -0.5);
    cameraPivot.add(camera);
    camera.position.copy(cameraOffset);
    // Look at the pivot's center
